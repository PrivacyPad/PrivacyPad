...
interface IPrivacyPresale {
    ...
    /**
     * @dev Emitted when the presale pool is initialized.
     * @param creator Address of the contract owner who initialized the presale.
     * @param amount Amount of tokens deposited.
     * @param liquidityTokens Amount of tokens allocated for liquidity.
     * @param presaleTokens Amount of tokens allocated for the presale.
     * @param timestamp Block timestamp when the initialization occurred.
     */
